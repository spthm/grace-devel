...
public:
    ...
    __device__ grace::uinteger64 operator() (const grace::uinteger64& a,
                                             const grace::uinteger64& b) {
...
int main(int argc, char* argv[]) {
    ...
    /**************************************/
    //
    // a = 1011 1001 0001 1011 1111 0101 0110 1101 1011 1001 0001 1011 1111 0101 0110 1101 = 13338524572993713517
    // b = 0011 1001 0001 1011 1111 0101 0110 1101 1011 1001 0001 1011 1111 0101 0110 1101 = 4115152536138937709
    // length of common prefix = 0

    // a = 1011 1001 0001 1011 1111 0101 0110 1101 1011 1001 0001 1011 1111 0101 0110 1101 = 13338524572993713517
    // b = 1011 1001 0001 1011 1111 0101 0110 1101 1011 1001 0001 1011 1111 0101 0110 1101 = 13338524572993713517
    // length of common prefix = 64

    grace::uinteger64 As[2] = {13338524572993713517, 13338524572993713517};
    grace::uinteger64 Bs[2] = {4115152536138937709,  13338524572993713517};
    grace::uinteger64 actuals[3] = {0, 64};

    thrust::device_vector<grace::uinteger64> d_As(As, As+2);
    thrust::device_vector<grace::uinteger64> d_Bs(Bs, Bs+2);

    thrust::device_vector<grace::uinteger64> d_calculated(2);
    thrust::transform(d_As.begin(), d_As.end(),
                      d_Bs.begin(),
                      d_calculated.begin(),
                      bit_prefix_functor());
    thrust::host_vector<grace::uinteger64> h_calculated = d_calculated;
    ...
    thrust::uniform_int_distribution<grace::uinteger64> rand_uint;

    thrust::host_vector<grace::uinteger64> h_As(N);
    thrust::host_vector<grace::uinteger64> h_Bs(N);
    for (int i=0; i<N; i++) {
    ...
    bool correct = true;
    for (int i=0; i<N; i++) {
        grace::uinteger64 prefix_length = grace::bit_prefix_length(h_As[i],
                                                                   h_Bs[i]);
