...
template <> struct format_traits<JPEG>
{
	static bool is_format(std::istream &in);
	static bool handle_extension(const std::string &ext);

	static const bool has_transparency = false;
	static const bool is_lossless = false;
...
// $Id: jpeg.h 2977 2010-08-18 22:37:40Z rodolfo $
